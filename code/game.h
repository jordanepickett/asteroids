...
static Vertex ASTEROID[8] = {
    {{ -0.8f,  0.3f }, {1.f, 1.f, 1.f}},
    {{ -0.4f,  0.9f }, {1.f, 1.f, 1.f}},
    {{  0.3f,  1.0f }, {1.f, 1.f, 1.f}},
    {{  0.9f,  0.3f }, {1.f, 1.f, 1.f}},
    {{  0.7f, -0.5f }, {1.f, 1.f, 1.f}},
    {{  0.1f, -1.0f }, {1.f, 1.f, 1.f}},
    {{ -0.6f, -0.8f }, {1.f, 1.f, 1.f}},
    {{ -1.0f, -0.2f }, {1.f, 1.f, 1.f}}
};
